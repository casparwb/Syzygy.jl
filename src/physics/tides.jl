...
"""
function apsidal_motion_constant_over_tidal_timescale(
        mass::Quantity, radius,
        envelope_mass, envelope_radius,
        stellar_type, luminosity,
        mass_perturber,
        semi_major_axis, Z = 0.02
    ...
    return apsidal_motion_constant_over_tidal_timescale(
        mass, radius,
        envelope_mass, envelope_radius,
        stellar_type, luminosity,
        mass_perturber,
...
function k_over_T_convective(
        mass::Quantity, radius, envelope_mass, envelope_radius,
        luminosity, Z = 0.02
    )
...
function k_over_T_convective(
        mass::Float64, radius, envelope_mass, envelope_radius,
        luminosity, Z = 0.02
    )
    return k_over_T_convective_(mass, radius, envelope_mass, envelope_radius, luminosity, Z)
end

function k_over_T_convective_(
        mass, radius, envelope_mass, envelope_radius,
        luminosity, Z
    )
    ...
    log10z = log10(Z)
    a = 0.63 * log10z + 2.72  # a(z) for envelope
    b = -0.219 * log10z + 0.68  # b(z) for envelope
    c = -0.023 * log10z + 0.22 # c(z) for envelope)
