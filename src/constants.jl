...
const tidal_structure_coefficients = Dict{Tuple{Float64, Int64}, SVector{6, Float64}}(
    (1.5, 2) => SA[-0.397, 1.678, 1.277, -12.42, 9.446, -5.55],
    (1.5, 3) => SA[-0.909, 1.574, 12.37, -57.4, 80.1, -46.43],
    (2.0, 2) => SA[-0.517, -0.906, 23.88, -93.49, 112.3, -44.15],
    (2.0, 3) => SA[-1.04, -1.354, 37.64, -139.9, 168.2, -66.53],
    (3.0, 2) => SA[-1.124, 0.877, -13.37, 21.55, -16.48, 4.124],
    (3.0, 3) => SA[-1.703, 2.653, -14.34, 12.85, -0.492, -3.6],
