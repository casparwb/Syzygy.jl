...
function lyapunov_exponent(system; t_sim, epsilon = 1.0e-6, simulation_args...)
    ...
    return λ = 1 / t_final * log(norm(final_separation_vector) / norm(initial_separation_vector))
end
