...
The package uses the [DifferentialEquations.jl](https://diffeq.sciml.ai/) ecosystem to solve the governing differential equations. This makes the package highly performant and flexible, allowing for both fixed and adaptive timestepping with adjustable error tolerances. 
